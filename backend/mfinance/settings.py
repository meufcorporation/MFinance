"""
Django settings for mfinance project.
"""
...
WSGI_APPLICATION = 'mfinance.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='mfinance'),
...
if config('ENABLE_OTEL', default=False, cast=bool):
    ...
    # Initialize tracing
    trace.set_tracer_provider(TracerProvider(resource=Resource.create({"service.name": "mfinance"})))
